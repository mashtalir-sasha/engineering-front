...
let fileswatch   = 'html,htm,txt,json,md,php'; // List of files extensions for watching & hard reload (comma separated)
...
function browsersync() {
	browserSync.init({
		/*server: { baseDir: 'app' },
		notify: false,*/
		proxy: 'engineering-front', // Прописать название папки в Опенсервере
		notify: false,
...
function scripts() {
	return src([
		...
		'app/libs/jquery.parallax/jquery.parallax.js',
		//'app/libs/wow.js/wow.min.js',
		//'app/libs/matchHeight/dist/jquery.matchHeight.js',
		//'app/libs/jquery-accordion/js/jquery-ui-1.9.2.custom.min.js',
